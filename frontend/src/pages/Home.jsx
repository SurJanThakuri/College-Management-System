        ...
        <>
            ...
            <main className='scroll-snap-type-y mandatory'>
                <div id='home' className="hero-section scroll-snap-start h-[100vh] w-full bg-white" style={{ backgroundImage: `url(/images/hero.jpg)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
                    <div className="hero-text h-full mx-4 flex flex-col items-start justify-center">
                        <h1 className="text-6xl font-bold cursor-pointer">ipsum dolor</h1>
                        <h1 className="text-6xl font-bold cursor-pointer">Lorem ipsum do sit</h1>
                        <h1 className="text-6xl font-bold cursor-pointer">do sit.</h1>
                        <h2 className='text-xl mt-6 cursor-pointer'> Blanditiis recusandae dignissimos molestiae veniam.</h2>
                        <h2 className='text-xl cursor-pointer'>amet consectetur adipisicing elit</h2>
                ...
                <div id='programs' className="programs scroll-snap-start pt-16 pb-10 bg-white">
                    ...
                    <div className="cards flex items-center justify-center  p-14 gap-4">
                        <div className="card text-center hover:shadow-gray-700 hover:shadow-md hover:border-gray-100 hover:border-t-blue-600 hover:border-t-4 transition-all duration-300 ease-in-out w-1/4 flex flex-col gap-4 border-gray-300 border-2 p-10 h-70 rounded-md">
                    ...
                    <div id='about' className="about bg-white flex mx-12 my-20 rounded-xl shadow-xl">
                        <div className="img w-1/2">
                            <img src="/images/about.jpg" className='rounded-l-xl h-full' alt="" />
                        </div>
                        <div className="main w-1/2 flex flex-col justify-center gap-6 p-10">
                            <div>
                ...
                <div id='gallery' className="gallery py-16">
                    ...
                    <div className="cards flex flex-wrap gap-8 justify-center items-center">
                        <div className="card w-1/3 rounded-3xl shadow-xl h-auto ">
                            <div className="img">
                ...
                <div id='services' className="features py-10 mb-20">
                    <div className="bg w-full h-[60vh] pt-16 pb-10" style={{ backgroundImage: `url(/images/blue-bg.jpg)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
                        ...
                        <div className="cards z-10 flex items-center justify-center  p-14 gap-4">
                            <div className="card bg-white text-center hover:shadow-gray-700 hover:shadow-md hover:border-gray-100 transition-all duration-300 ease-in-out w-1/3 flex flex-col gap-4 shadow-md p-10 h-70 rounded-md">
                                <div className="icon flex items-center justify-center">
                                    <img className='h-16' src="/images/diploma.png" alt="" />
                                </div>
                                <h2 className='font-extrabold text-2xl text-wrap cursor-pointer'>Academic Support</h2>
                            ...
                            <div className="card bg-white text-center hover:shadow-gray-700 hover:shadow-md hover:border-gray-100  transition-all duration-300 ease-in-out w-1/3 flex flex-col gap-4 shadow-md p-10 h-70 rounded-md">
                                ...
                                <h2 className='font-extrabold text-2xl text-wrap cursor-pointer'>Career Assistance</h2>
                            ...
                            <div className="card bg-white text-center hover:shadow-gray-700 hover:shadow-md hover:border-gray-100 transition-all duration-300 ease-in-out w-1/3 flex flex-col gap-4 shadow-md p-10 h-70 rounded-md">
                                ...
                                <h2 className='font-extrabold text-2xl text-wrap cursor-pointer'>Student Life</h2>
                ...
                <div id='contact' className="contact pt-20 mt-16">
                    <div className="bg h-[80vh] py-8 flex items-center justify-center flex-col gap-4" style={{ backgroundImage: `url(/images/contact-bg.jpg)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
